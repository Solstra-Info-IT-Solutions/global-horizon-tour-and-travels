  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed inset-0 z-[110] bg-[#082f3b]/25 backdrop-blur-[2px] transition-all duration-300 ${
          isOpen
      ...
      <div className="fixed bottom-4 right-4 z-[130] flex flex-col items-end gap-3 sm:bottom-7 sm:right-7">
    ...
    <div className="hidden pr-1 text-left sm:block">
      ...
      <p className="mt-0.5 text-[9px] text-white/75">
        ...
        <button
          ...
          className={`group flex items-center gap-3 rounded-full px-3.5 py-3 text-white shadow-[0_15px_40px_rgba(14,70,85,0.30)] transition-all duration-300 hover:-translate-y-1 sm:px-5 sm:py-3.5 ${
            isOpen
              ? "bg-[#123f55]"
      ...
      <div
        className={`fixed inset-x-0 bottom-0 z-[120] flex justify-center transition-all duration-500 sm:inset-auto sm:bottom-[170px] sm:right-7 sm:block sm:w-[380px] ${
          isOpen
            ? "pointer-events-auto translate-y-0 opacity-100"
            : "pointer-events-none translate-y-full opacity-0 sm:translate-y-5"
        }`}
      >
        {/* =====================================================
            POPUP
        ...
        <div className="relative w-full overflow-hidden rounded-t-[28px] border border-white/70 bg-[#faf9f6]/98 shadow-[0_-20px_60px_rgba(14,70,85,0.20)] backdrop-blur-xl sm:max-h-[calc(100vh-210px)] sm:rounded-[26px] sm:shadow-[0_25px_70px_rgba(14,70,85,0.25)]">

          {/* MOBILE HANDLE */}

          <div className="flex justify-center pt-3 sm:hidden">
            <div className="h-1.5 w-12 rounded-full bg-[#123f55]/15" />
          </div>
          ...
          <div className="relative overflow-hidden border-b border-[#123f55]/10 px-5 pb-5 pt-4 sm:px-6 sm:pt-5">
            ...
            {activeMenu && (
              <button
                ...
                className="relative z-10 mb-4 flex items-center gap-1.5 text-[10px] font-bold tracking-[0.12em] text-[#14596a] transition-colors hover:text-[#e7ae3c]"
              >
                <ChevronLeft size={15} />
                BACK
              </button>
            ...
            <div className="relative z-10 flex items-start justify-between gap-4">
              ...
              <div>
                ...
                <h3 className="mt-3 font-serif text-[25px] font-bold leading-tight text-[#123f55] sm:text-[24px]">
                  {getTitle()}
                </h3>

                <p className="mt-2 max-w-[280px] text-[12px] leading-5 text-[#687276]">
                  {getSubtitle()}
                </p>
              </div>
              ...
              <button
                type="button"
                onClick={closeAssistant}
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#123f55]/10 bg-white text-[#687276] transition-all duration-300 hover:border-[#123f55]/25 hover:text-[#123f55]"
          ...
          <div className="max-h-[45vh] overflow-y-auto p-3 pb-4 sm:max-h-[calc(100vh-430px)] sm:p-4">
              ...
              {currentItems.map((item) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-[10px] leading-4 text-[#748084]">
                      {item.subtitle}
                    </p>
                  </div>
